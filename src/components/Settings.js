...
export default function Settings({ personList, setPersonList, collector, setCollector, monthlyResidents, setMonthlyResidents, users, setUsers }) {
  ...
  const clearAllData = () => {
    ...
    const updatedUsers = users.filter(u => u.role === "admin");
    setUsers(updatedUsers);
    localStorage.setItem("pgUsers", JSON.stringify(updatedUsers));

    alert("All data cleared except superadmin!");
  };
